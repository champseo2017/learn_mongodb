...
// หาผลรวมของด็อกคิวเมนต์ทั้งหมด หาผลรวม stock ทั้งหมด
db.stock.aggregate([{ $group: { _id: null, TotalStock: { $sum: "$stock" } } }]);

// ตัวอย่างการรวมกลุ่มพร้อมหาผลรวม $sum
// - จัดกลุ่ม stock หนังสือ เพื่อดูว่าหนังสือแต่ละหมวดมีเท่าไร
// - แบ่งกลุ่มของหนังสือตาม $name
// - สร้างฟิลด์ TotalStock เพื่อเก็บผลรวม
// - ใช้ $sum หาผลรวมยอดหนังสือใน stock ตาม $name แล้วเก็บค่าลง field TotalStock
