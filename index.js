...
รูปแบบ
{
  ...
  ตัวอย่างการเชือมที่เท่ากันในจุดเดียว
  ต้องการแสดงข้อมูลการสั่งซื้อจาก คอลเล็กชั่น order และจำนวนยอดหนังสือในสต๊อกจากคอลเล็กชัน stock ให้อยู่ในด็อกคิวเมนต์เดียวกัน
  ...
  จากโจทย์เราจะดึกด็อกคิวเมนต์จากคอลเล็กชัน order เชื่อมเข้ากับด็อกคิวเมนต์จากคอลเล็กชั่น stock โดยการฟิลด์ item จากคอลเล็กชัน order และฟิลด์ name จากคอลเล็กชัน stock มี
  ...
  ในผลลัพธ์จะได้ 2 ด็อกคิวเมนต์หลักจากคอลเล็กชัน order และมีฟิลด์ stock_data เก็บข้อมูลที่เชื่อมกับด็อกคิวเมนต์จากคอลเล็กชัน stock เพิ่มเข้ามาอยู่ในอาร์เรย์ ซึ้งค่าของ name จะตรงกับค่าในฟิลด์ item โดยถูกใช้อ้างอิงในการเชื่อมด็อกคิวเมนต์
